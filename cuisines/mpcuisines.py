"""
mpcuisines.py
mpcuisines.py is a modification of cuisines.py that uses multiprocessing functionality.
...
if __name__ == '__main__':
    ...
    recipefile = "/home/mjbeattie/PycharmProjects/cuisines/cuisines/yummly.json"
